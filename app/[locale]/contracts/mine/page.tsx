    ...
    <section className="app-page">
      <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">{t("minePageDescription")}</p>
        </div>
      ...
      {loading ? (
        ...
        <div className="space-y-3">
          ...
          {contracts.length === 0 && <p className="text-sm text-muted-foreground">{t("mineEmpty")}</p>}
        </div>
      )}
      ...
      {showCompleteModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4 backdrop-blur-[1px]">
          <div className="max-w-md w-full rounded-xl border border-border/60 bg-card p-6 shadow-lg dark:shadow-black/40">
            ...
            <form onSubmit={e => completeContract(e, showCompleteModal)} className="mt-4 space-y-4">
              <div>
